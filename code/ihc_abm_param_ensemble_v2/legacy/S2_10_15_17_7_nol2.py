...
# ===== Scenario 2: Bundled payment with surplus retention =====
SCENARIO = "bundle_surplus"
ENABLE_RHO = True
ENABLE_V = True
ENABLE_D = True
...
def create_professional_heatmap():
    ...
    ax1.set_title("S2: Treated Volumes (Share)", fontsize=14, fontweight='bold')
    ...
    ax2.set_title("S2: Treated Volumes (Absolute)", fontsize=14, fontweight='bold')
...
ax21a.set_ylabel("Total Capacity (Bed Days)")
ax21a.legend()
...
print("S2 Ultimate Version 完成！主要增强特性：")
print("✓ 真实地理布局和人口密度抽样")
print("✓ 等待容忍阈值 + 外流分类统计")
